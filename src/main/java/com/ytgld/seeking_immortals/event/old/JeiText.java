    ...
    public void registerRecipes(IRecipeRegistration registration) {
        {
            ...
            registration.addIngredientInfo(new ItemStack(Items.blood_god.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.blood_god").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all").append(Component.translatable("item.seeking_immortals.nightmare_base"))));
            registration.addIngredientInfo(new ItemStack(Items.lead.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.lead").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all").append(Component.translatable("item.seeking_immortals.nightmare_base"))));
            ...
            registration.addIngredientInfo(new ItemStack(Items.tricky_puppets.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.tricky_puppets").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all")
                    .append(Component.translatable("item.seeking_immortals.nightmare_base_black_eye"))));
            ...
            registration.addIngredientInfo(new ItemStack(Items.end_bone.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.end_bone").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all")
                    .append(Component.translatable("item.seeking_immortals.nightmare_base_stone"))));
            ...
            registration.addIngredientInfo(new ItemStack(Items.candle.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.candle").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all")
                    .append(Component.translatable("item.seeking_immortals.nightmare_base_reversal"))));
            ...
            registration.addIngredientInfo(new ItemStack(Items.hypocritical_self_esteem.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.hypocritical_self_esteem").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all")
                    .append(Component.translatable("item.seeking_immortals.nightmare_base_redemption"))));
            ...
            registration.addIngredientInfo(new ItemStack(Items.apple.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.apple").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all")
                    .append(Component.translatable("item.seeking_immortals.nightmare_base_fool"))));
            ...
            registration.addIngredientInfo(new ItemStack(Items.ring.get()), VanillaTypes.ITEM_STACK, Component.translatable("seeking_immortals.jei.item.seeking_immortals.ring").append(Component.translatable("seeking_immortals.jei.item.seeking_immortals.nightmare_base.all")
                    .append(Component.translatable("item.seeking_immortals.nightmare_base_insight"))));
